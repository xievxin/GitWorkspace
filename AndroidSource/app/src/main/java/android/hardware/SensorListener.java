 ...
 * 
 * @deprecated Use 
 * {@link SensorEventListener SensorEventListener} instead.
 */
@Deprecated
public interface SensorListener {
     ...
     * 
     * <p>{@link SensorManager#SENSOR_ORIENTATION SENSOR_ORIENTATION},
     * {@link SensorManager#SENSOR_ORIENTATION_RAW SENSOR_ORIENTATION_RAW}:<p>
     ...
     *
     * <p>{@link SensorManager#SENSOR_ACCELEROMETER SENSOR_ACCELEROMETER}:<p>
     ...
     *    {@link SensorManager#STANDARD_GRAVITY -STANDARD_GRAVITY},
     *    which correspond to the force the device applies on the table in reaction
     *    to gravity.</li>
     *
     * <p>{@link SensorManager#SENSOR_MAGNETIC_FIELD SENSOR_MAGNETIC_FIELD}:<p>
