...
public interface AccountManagerFuture<V> {
     ...
     * @throws AuthenticatorException if there was an error communicating with
     * the authenticator or if the authenticator returned an invalid response
     * @throws IOException if the authenticator returned an error response that indicates
