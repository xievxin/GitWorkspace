...
public class CommonTimeConfig {
    ...
    /**
     * Release all native resources held by this {@link CommonTimeConfig} instance.  Once
     * resources have been released, the {@link CommonTimeConfig} instance is
     * disconnected from the native service and will throw a {@link RemoteException} if
     ...
     * {@link CommonTimeConfig} instance to indicate that the connection to the native
     * media server has been broken and that the {@link CommonTimeConfig} instance will
    ...
    public interface OnServerDiedListener  {
         ...
         * {@link CommonTimeConfig} instance to the common time service will be broken.
         */
        void onServerDied();
    }
