 ...
 * @see com.getui.gmsm.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADBlockCipher
{
     ...
     * @throws com.getui.gmsm.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
