package com.getui.gmsm.bouncycastle.ec;
...
//    }
    ...
    public static class F2m extends ECPoint
    {
        ...
        /* (non-Javadoc)
         * @see com.getui.gmsm.bouncycastle.ec.ECPoint#getEncoded()
         */
        public byte[] getEncoded()
        {
            if (this.isInfinity()) 
...
//            ECFieldElement.F2m.checkFieldElements(a.x, b.x);
        ...
        /* (non-Javadoc)
         * @see com.getui.gmsm.bouncycastle.ec.ECPoint#add(com.getui.gmsm.bouncycastle.ec.ECPoint)
         */
        public ECPoint add(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see com.getui.gmsm.bouncycastle.ec.ECPoint#subtract(com.getui.gmsm.bouncycastle.ec.ECPoint)
         */
        public ECPoint subtract(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see com.getui.gmsm.bouncycastle.ec.ECPoint#twice()
         */
        public ECPoint twice()
        {
            if (this.isInfinity()) 
