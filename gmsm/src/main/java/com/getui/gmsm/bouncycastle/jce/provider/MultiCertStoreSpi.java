...
import com.getui.gmsm.bouncycastle.jce.MultiCertStoreParameters;
    ...
    extends CertStoreSpi
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        {
            throw new InvalidAlgorithmParameterException("com.getui.gmsm.bouncycastle.jce.provider.MultiCertStoreSpi: parameter must be a MultiCertStoreParameters object\n" +  params.toString());
        }
