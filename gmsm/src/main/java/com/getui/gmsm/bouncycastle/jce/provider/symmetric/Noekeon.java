...
import com.getui.gmsm.bouncycastle.crypto.engines.NoekeonEngine;
...
public final class Noekeon
{
        ...
        extends HashMap
    {
        public Mappings()
        {
            put("AlgorithmParameters.NOEKEON", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.Noekeon$AlgParams");

            put("AlgorithmParameterGenerator.NOEKEON", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.Noekeon$AlgParamGen");

            put("Cipher.NOEKEON", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.Noekeon$ECB");

            put("KeyGenerator.NOEKEON", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.Noekeon$KeyGen");
        }
    }
}
