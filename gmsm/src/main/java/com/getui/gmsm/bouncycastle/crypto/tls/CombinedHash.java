...
class CombinedHash implements Digest
{
    ...
    /**
     * @see com.getui.gmsm.bouncycastle.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see com.getui.gmsm.bouncycastle.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see com.getui.gmsm.bouncycastle.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see com.getui.gmsm.bouncycastle.crypto.Digest#update(byte[],int,int)
     */
    ...
    /**
     * @see com.getui.gmsm.bouncycastle.crypto.Digest#doFinal(byte[],int)
     */
    ...
    /**
     * @see com.getui.gmsm.bouncycastle.crypto.Digest#reset()
     */
    public void reset()
    {
        md5.reset();
