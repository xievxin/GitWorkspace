...
import com.getui.gmsm.bouncycastle.crypto.engines.Grain128Engine;
...
public final class Grain128
{
        ...
        extends HashMap
    {
        public Mappings()
        {
            put("Cipher.Grain128", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.Grain128$Base");
            put("KeyGenerator.Grain128", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.Grain128$KeyGen");
        }
    }
}
