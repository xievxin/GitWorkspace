...
import com.getui.gmsm.bouncycastle.asn1.misc.CAST5CBCParameters;
import com.getui.gmsm.bouncycastle.crypto.CipherKeyGenerator;
import com.getui.gmsm.bouncycastle.crypto.engines.CAST5Engine;
...
public final class CAST5
{
        ...
        extends HashMap
    {
        public Mappings()
        {
            put("AlgorithmParameters.CAST5", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.CAST5$AlgParams");
            put("Alg.Alias.AlgorithmParameters.1.2.840.113533.7.66.10", "CAST5");

            put("AlgorithmParameterGenerator.CAST5", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.CAST5$AlgParamGen");
            put("Alg.Alias.AlgorithmParameterGenerator.1.2.840.113533.7.66.10", "CAST5");

            put("Cipher.CAST5", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.CAST5$ECB");
            put("Cipher.1.2.840.113533.7.66.10", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.CAST5$CBC");

            put("KeyGenerator.CAST5", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.CAST5$KeyGen");
