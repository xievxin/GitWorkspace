...
import com.getui.gmsm.bouncycastle.crypto.engines.DESedeEngine;
import com.getui.gmsm.bouncycastle.crypto.engines.DESedeWrapEngine;
import com.getui.gmsm.bouncycastle.crypto.engines.RFC3211WrapEngine;
import com.getui.gmsm.bouncycastle.crypto.generators.DESedeKeyGenerator;
...
import com.getui.gmsm.bouncycastle.crypto.paddings.ISO7816d4Padding;
...
import com.getui.gmsm.bouncycastle.jce.provider.JCESecretKeyFactory;
...
public final class DESede
{
  ...
  /**
        ...
        extends HashMap
    {
        public Mappings()
        {
            put("Cipher.DESEDE", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$ECB");
            put("Cipher." + PKCSObjectIdentifiers.des_EDE3_CBC, "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$CBC");
            put("Cipher." + OIWObjectIdentifiers.desCBC, "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$CBC");
            put("Cipher.DESEDEWRAP", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$Wrap");
            put("Cipher." + PKCSObjectIdentifiers.id_alg_CMS3DESwrap, "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$Wrap");
            put("Cipher.DESEDERFC3211WRAP", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$RFC3211");

            put("KeyGenerator.DESEDE", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$KeyGenerator");
            put("KeyGenerator." + PKCSObjectIdentifiers.des_EDE3_CBC, "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$KeyGenerator3");
            put("KeyGenerator.DESEDEWRAP", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$KeyGenerator");

            put("SecretKeyFactory.DESEDE", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$KeyFactory");

            put("Mac.DESEDECMAC", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$CMAC");
            put("Mac.DESEDEMAC", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$CBCMAC");
            put("Alg.Alias.Mac.DESEDE", "DESEDEMAC");

            put("Mac.DESEDEMAC/CFB8", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$DESedeCFB8");
            put("Alg.Alias.Mac.DESEDE/CFB8", "DESEDEMAC/CFB8");

            put("Mac.DESEDEMAC64", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$DESede64");
            put("Alg.Alias.Mac.DESEDE64", "DESEDEMAC64");

            put("Mac.DESEDEMAC64WITHISO7816-4PADDING", "com.getui.gmsm.bouncycastle.jce.provider.symmetric.DESede$DESede64with7816d4");
