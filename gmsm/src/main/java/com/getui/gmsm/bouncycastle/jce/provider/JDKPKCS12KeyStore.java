...
import com.getui.gmsm.bouncycastle.asn1.ASN1Set;
import com.getui.gmsm.bouncycastle.asn1.BERConstructedOctetString;
import com.getui.gmsm.bouncycastle.asn1.BEROutputStream;
import com.getui.gmsm.bouncycastle.asn1.DERBMPString;
import com.getui.gmsm.bouncycastle.asn1.DEREncodable;
import com.getui.gmsm.bouncycastle.asn1.DERNull;
...
import com.getui.gmsm.bouncycastle.asn1.DEROutputStream;
import com.getui.gmsm.bouncycastle.asn1.DERSequence;
import com.getui.gmsm.bouncycastle.asn1.DERSet;
import com.getui.gmsm.bouncycastle.asn1.pkcs.AuthenticatedSafe;
import com.getui.gmsm.bouncycastle.asn1.pkcs.CertBag;
import com.getui.gmsm.bouncycastle.asn1.pkcs.ContentInfo;
import com.getui.gmsm.bouncycastle.asn1.pkcs.EncryptedData;
import com.getui.gmsm.bouncycastle.asn1.pkcs.MacData;
import com.getui.gmsm.bouncycastle.asn1.pkcs.PKCS12PBEParams;
import com.getui.gmsm.bouncycastle.asn1.pkcs.PKCSObjectIdentifiers;
import com.getui.gmsm.bouncycastle.asn1.pkcs.Pfx;
import com.getui.gmsm.bouncycastle.asn1.pkcs.SafeBag;
import com.getui.gmsm.bouncycastle.asn1.util.ASN1Dump;
...
import com.getui.gmsm.bouncycastle.asn1.x509.DigestInfo;
import com.getui.gmsm.bouncycastle.asn1.x509.SubjectKeyIdentifier;
import com.getui.gmsm.bouncycastle.asn1.x509.SubjectPublicKeyInfo;
import com.getui.gmsm.bouncycastle.asn1.x509.X509Extensions;
import com.getui.gmsm.bouncycastle.asn1.x509.X509ObjectIdentifiers;
import com.getui.gmsm.bouncycastle.jce.interfaces.BCKeyStore;
import com.getui.gmsm.bouncycastle.jce.interfaces.PKCS12BagAttributeCarrier;
import com.getui.gmsm.bouncycastle.util.Arrays;
import com.getui.gmsm.bouncycastle.util.Strings;
import com.getui.gmsm.bouncycastle.util.encoders.Hex;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            com.getui.gmsm.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo eIn = new com.getui.gmsm.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo((ASN1Sequence)b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            com.getui.gmsm.bouncycastle.asn1.pkcs.PrivateKeyInfo pIn = new com.getui.gmsm.bouncycastle.asn1.pkcs.PrivateKeyInfo((ASN1Sequence)b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            com.getui.gmsm.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new com.getui.gmsm.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
