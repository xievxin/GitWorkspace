...
public class EC5Util
{
    ...
    public static com.getui.gmsm.bouncycastle.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new com.getui.gmsm.bouncycastle.jce.spec.ECParameterSpec(
            curve,
    ...
    public static com.getui.gmsm.bouncycastle.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
