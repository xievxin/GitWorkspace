...
import com.getui.gmsm.bouncycastle.ec.ECFieldElement;
...
//		System.out.println("私钥：");
		keys[0] = ecpriv.getD().toString(16);
//		System.out.println(keys[0]);

//		System.out.println("公钥：");
		keys[1] = Util.byteToHex(ecpub.getQ().getEncoded());
